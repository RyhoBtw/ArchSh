...
paru -S etcher-bin gimp bitwarden spotify discord multimc-bin jre-openjdk telegram-desktop-bin ckb-next nvtop noto-fonts-cjk noto-fonts-emoji --noconfirm
