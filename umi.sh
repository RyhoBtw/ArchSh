...
paru -S nemo solaar ranger lf tldr bat downgrade ripgrep procs rsync carla flameshot man xdg-ninja exfat-utils fzf galculator btop redshift-minimal arandr mpv peazip cups qbittorrent --noconfirm
